    ...
    def __pqc_13(self, weights0, weights1):
        ...
        for l in range(self.layers):
            ...
            for i in range(0, self.qubit):
                qml.CRZ(weights1[l, i, 0], wires=[
                        i, (i + self.qubit - 1) % self.qubit])
            for i in range(self.qubit):
